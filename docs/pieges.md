...
Sur les **88** migrations : **52 insertions vues, 40 analysées, 1968 valeurs confrontées** (mesuré le
...
**les 88 migrations**, pas les six du lot : la faute est une habitude d'écriture, pas un accident de
sprint (§E.61).
