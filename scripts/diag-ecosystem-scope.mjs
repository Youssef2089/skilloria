...
// Les trois inventaires vivent dans scripts/inventaire-cloisonnement.mjs depuis le
// 20/09/2026 : la recette 3.3 en derive sa matrice. Ce diagnostic garde leur
// COMPLETUDE (une route ou un module non declare rougit ci-dessous).
import { INVENTORY, LIB_INVENTORY, ROUTES_VIA_MOTEUR } from './inventaire-cloisonnement.mjs'
