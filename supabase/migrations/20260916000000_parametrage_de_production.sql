...
values
  ('dec68d15-6b55-41dd-b307-86230d88e53c', '90477d2f-7b3a-419a-b158-3a1660aa966a', null, null, '#0ea5e9', '#6366f1', null, array['Azure', 'Dynamics 365', 'Power Platform', 'Power BI', 'SharePoint', 'Teams', 'Microsoft 365', 'Copilot', 'Fabric', 'SQL Server']::text[], '[{"icon":"dynamics","label":"Dynamics 365"},{"icon":"azure","label":"Azure"},{"icon":"power-platform","label":"Power Platform"},{"icon":"microsoft-365","label":"Microsoft 365"},{"icon":"copilot","label":"Copilot"}]'::jsonb, 'expert Microsoft certifié', 'écosystème Microsoft', 'Spécialité Microsoft principale', 'Domaine Microsoft recherché', '{}'::jsonb, '{"title":"Skilloria 365 — Experts Microsoft certifiés","description":"La marketplace premium des experts certifiés de l''écosystème Microsoft."}'::jsonb)
on conflict do nothing;
