...
export async function generateMetadata({ params }: PageParams): Promise<Metadata> {
  ...
  return {
    ...
    description: t('confidentialite.meta_description'),
  }
}

export default async function PolitiqueConfidentialitePage({ params }: PageParams) {
  const { locale } = await params
  ...
  return (
    <LegalPageShell
      ...
      content={loadLegalDoc('politique-de-confidentialite')}
    />
  )
}
