 ...
 *
 * Rythme d'ORIGINE : 1.0. (Un ralentissement à 1.6 + une pause de lecture de
 * fin de phase avaient rendu les démos trop lentes — expert 8→25 s,
 * entreprise 17→39 s — et ont été retirés. Les transitions CSS ci-dessous sont
 * revenues à leurs durées d'origine en cohérence.)
 */
const TEMPO = 1.0
