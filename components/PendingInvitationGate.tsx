  ...
  async function accept() {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (code === 'compte_verification_indisponible') setErr(t('err_compte_verification_indisponible'))
        else if (code === 'invitation_lecture_indisponible') setErr(t('err_invitation_lecture_indisponible'))
